...
const spells = {
    [Spell.Fireball]: {
        ...
        "highLvl": {
            "has": true,
            "from": 4,
            "description": "Якщо ти виконуєш це заклинання, витрачаючи магічний слот 4 рівня або вищого, його ушкодження збільшуються на 1к6 за кожен рівень слота вище 3-го.",
            "effect": ""
        },
        "concentration": false,
        "targets": 0,
    ...
    [Spell.Bless]: {
        ...
        "lvl": 1,
        "school": "причарування",
        "description": "Ти благословляєш не більше трьох істот на твій вибір в межах дистанції. Кожен раз, коли до закінчення ефекту заклинання ціль здійснює кидок атаки або кидок рятунку, вона може кинути додатково к4 і додати число, яке випало, до результату того кидка.",
        "distance": "6 метрів",
        "components": {
            "c": true,
            "t": true,
        ...
        "highLvl": {
            "has": true,
            "from": 2,
            "description": "Ти можеш обрати цілями по одній додатковій істоті за кожен рівень витраченого слота вище 1-го.",
            "effect": ""
        },
        "concentration": true,
        "targets": 3,
        ...
        "lvl": 1,
        "school": "втілення",
        "description": "Твоя молитва наповнює тебе божественною енергією. Доки заклинання триває, твої атаки зброєю завдають при попаданні 1к4 додаткових ушкоджень.",
        "distance": "На себе",
        "components": {
            "c": true,
            "t": true
    ...
    [Spell.HeroesFeast]: {
        ...
        "lvl": 6,
        "school": "виклик",
        "description": "Ти організовуєш шикарний бенкет, який включає чудову їжу та напої. Бенкет триває 1 годину, і зникає після закінчення цього строку, але позитивні ефекти не вступають в силу, доки цей час не пройде. У бенкеті можуть брати участь до дванадцяти істот.",
        "distance": "6 метрів",
        "components": {
            "c": true,
            "t": true,
